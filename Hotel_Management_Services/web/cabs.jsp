        ...
        <div class="row" style="margin-top: 51px;">
            <div class="col-md-2" id="menu-list">
                <ul style="list-style: none" >
                    ...
                    <li class="menu_active"><i class="fa fa-taxi" aria-hidden="true"></i><a href="cabs.jsp"> Cabs</a></li>
            ...
            <div class="col-md-10">
                <h4>Cabs booking control panel</h4>
                <hr/>
                <div class="panel panel-default">
                    <div class="panel-heading">Welcome to Cabs booking panel</div>
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                                <li class="active"><a href="#unsolved" data-toggle="tab">Current raids</a>
                                </li>
                                <li><a href="#oldproblems" data-toggle="tab">Completed raids</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade in active" id="unsolved">
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    ResultSet rs = ut.getCabbookings(1);
                                                    while(rs.next()){
                                                %>
                                                <tr>
                                                    <td><%=rs.getInt(1)%></td>
                                                    ...
                                                    <td><%=rs.getDate(6)%></td>
                                                    <td>
                                                        <form action="completeCab" method="post">
                                                            <input type="hidden" name="cab_book_id" value="<%=rs.getInt(1)%>">
                                                            <button class="btn btn-default">Received</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <%}%>
                                ...
                                <div class="tab-pane fade" id="oldproblems">
                                    <p><div class="panel panel-default">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    ResultSet ry = ut.getCabbookings(2);
                                                    while(ry.next()){
                                                %>
                                                <tr>
                                                    <td><%=ry.getInt(1)%></td>
